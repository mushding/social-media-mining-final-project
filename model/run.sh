...
#  python3 main.py --name "Add edge_attr (tag * commentNum (1, 2, 4))" --iteration 10000 --batch-size 1024 --lr-decay 200 --K 3 --embedding 8 --lambdas 0.000001
#  python3 main.py --name "Add edge_attr (tag * commentNum (1, 2, 4)) (64)" --iteration 10000 --batch-size 1024 --lr-decay 200 --K 3 --embedding 64 --lambdas 0.000001
 python3 main.py --name "item -> 20, user -> 40, (no duplicate) iteration 2000" --iteration 2000 --batch-size 1024 --lr-decay 200 --K 3 --embedding 512 --lambdas 0.000001
#  python3 main.py --name "Add edge_attr (tag * commentNum (1, 2, 4))" --iteration 10000 --batch-size 1024 --lr-decay 200 --K 3 --embedding 64 --lambdas 0.000001